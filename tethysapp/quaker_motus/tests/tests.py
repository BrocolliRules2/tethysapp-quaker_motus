    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.quaker_motus"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.quaker_motus.tests.tests"

        To run tests in the QuakerMotusTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.quaker_motus.tests.tests.QuakerMotusTestCase"

        To run only the test_if_tethys_platform_is_great function in the QuakerMotusTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.quaker_motus.tests.tests.QuakerMotusTestCase.test_if_tethys_platform_is_great"
...
class QuakerMotusTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(QuakerMotus)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(QuakerMotus)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/quaker-motus/')  # The final '/' is essential for all pages/controllers
